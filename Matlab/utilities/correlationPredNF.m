...
if isequal(size(Res.NF_estimated_fMRI), size(Res.NF_fMRI_test))
    correlation_value = corr2(Res.NF_estimated_fMRI,Res.NF_fMRI_test);
    ...
    correlation_value = corr2(pred,gtruth_firstPart);
    correlation_value_2 = corr2(pred,gtruth_secondPart);
end
