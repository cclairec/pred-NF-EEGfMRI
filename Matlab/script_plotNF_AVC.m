...
if strcmp(path,'')
    load('C:/Users/cpinte/Documents/Results/Res_P002_sS1s1_lNF3_tNF2/Res_P002_sS1s1_lNF3_tNF2.mat'); % Res matrix
    ResPath=['C:/Users/cpinte/Documents/Results/Res_P002_sS1s1_lNF3_tNF2/']; % path for saving figures
else
