...
if strcmp(path,'')
    load('C:/Users/cpinte/Documents/Results/Results_rho0/Res_P002_sS1s1_lNF1_tNF2/Res_P002_sS1s1_lNF1_tNF2.mat'); % Res matrix
    ResPath=['C:/Users/cpinte/Documents/Results/Results_rho0/Res_P002_sS1s1_lNF1_tNF2/']; % path for saving figures
else
    load(['C:/Users/cpinte/Documents/Results/Results_rho0/',path,'/',path,'.mat']); % Res matrix
    ResPath=['C:/Users/cpinte/Documents/Results/Results_rho0/',path,'/']; % path for saving figures
end
